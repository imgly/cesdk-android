 ...
 * @param actionContent the extra action content to be displayed on the left side of the header.
 * @param onClose the callback that should be invoked when the [icon] is clicked.
 * @param icon the icon that collapses the sheet.
 */
@Composable
fun SheetHeader(
    title: String,
