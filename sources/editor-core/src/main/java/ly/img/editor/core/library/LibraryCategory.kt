...
data class LibraryCategory(
    ...
    companion object {
        ...
        fun getElements(
            ...
            textWithFontCombinations: LibraryCategory = TextWithFontCombinations,
            ...
            return LibraryCategory(
                ...
                content = LibraryContent.Sections(
                    ...
                    sections = buildList {
                        ...
                        text.apply {
                            val content = if (!isSceneModeVideo) textWithFontCombinations.content else content
                            LibraryContent.Section(
                                titleRes = R.string.ly_img_editor_text,
                                sourceTypes = content.sourceTypes,
                                excludeSourceTypes = listOf(AssetSourceType.FontCombinations),
        ...
        /**
         * The default library category for text assets with font combinations.
         */
        val TextWithFontCombinations by lazy {
            LibraryCategory(
                ...
                tabUnselectedIcon = IconPack.TextFields,
                isHalfExpandedInitially = true,
                content = LibraryContent.TextWithFontCombinations,
            )
        }
