 ...
 */
fun Engine.addSystemGalleryAssetSources(configuration: SystemGalleryConfiguration = SystemGalleryConfiguration.Disabled) {
    val context: Context = applicationContext
    asset.addSource(SystemGalleryAssetSource(context, AssetSourceType.GalleryAllVisuals, configuration))
    asset.addSource(SystemGalleryAssetSource(context, AssetSourceType.GalleryImage, configuration))
    asset.addSource(SystemGalleryAssetSource(context, AssetSourceType.GalleryVideo, configuration))
}
