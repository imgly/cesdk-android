...
val IconPack.PreviewToggled: ImageVector
    get() {
        if (previewToggled != null) {
...
private var previewToggled: ImageVector? = null

@Preview
@Composable
private fun Preview() = IconPack.PreviewToggled.IconPreview()
