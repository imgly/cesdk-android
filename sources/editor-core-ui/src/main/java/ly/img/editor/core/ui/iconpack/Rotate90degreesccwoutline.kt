...
val IconPack.Rotate90degreesccwoutline: ImageVector
    get() {
        if (rotate90degreesccwoutline != null) {
            return rotate90degreesccwoutline!!
        }
        rotate90degreesccwoutline = Builder(
...
private var rotate90degreesccwoutline: ImageVector? = null
