...
val IconPack.Videocamoutline: ImageVector
    get() {
        if (videocamoutline != null) {
            return videocamoutline!!
        }
        videocamoutline = Builder(
...
private var videocamoutline: ImageVector? = null

@Preview
@Composable
private fun Preview() = IconPack.Videocamoutline.IconPreview()
