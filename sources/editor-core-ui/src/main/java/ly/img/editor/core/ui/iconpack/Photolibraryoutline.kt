...
val IconPack.Photolibraryoutline: ImageVector
    get() {
        if (photolibraryoutline != null) {
            return photolibraryoutline!!
        }
        photolibraryoutline = Builder(
...
private var photolibraryoutline: ImageVector? = null

@Preview
@Composable
private fun Preview() = IconPack.Photolibraryoutline.IconPreview()
