...
val IconPack.Videolibraryoutline: ImageVector
    get() {
        if (videolibraryoutline != null) {
            return videolibraryoutline!!
        }
        videolibraryoutline = Builder(
...
private var videolibraryoutline: ImageVector? = null

@Preview
@Composable
private fun Preview() = IconPack.Videolibraryoutline.IconPreview()
