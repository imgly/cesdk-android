...
val IconPack.SplitscreenBottomOutline: ImageVector
    get() {
        if (`splitscreen-bottom-outline` != null) {
            return `splitscreen-bottom-outline`!!
        }
        `splitscreen-bottom-outline` = Builder(
...
private var `splitscreen-bottom-outline`: ImageVector? = null
