...
fun FontSheet(
    ...
    Column {
        SheetHeader(
            title = stringResource(id = R.string.ly_img_editor_sheet_font_title),
        ...
        FontListUi(
            ...
            onSelectFont = { fontData ->
                onEvent(Event.OnTypefaceChange(uiState.designBlock, fontData.typeface))
            },
        )
    }
}

class FontBottomSheetContent(
    override val type: SheetType,
    val uiState: FontUiState,
) : BottomSheetContent
