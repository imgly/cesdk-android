...
private const val ALLOW_RESIZE_INTERACTION_KEY = "page/allowResizeInteraction"
private const val RESTRICT_RESIZE_INTERACTION_KEY = "page/restrictResizeInteractionToFixedAspectRatio"
...
suspend fun EditorScope.applyForceCrop(
    ...
    val isPage = engine.block.getType(block) == DesignBlockType.Page.key
...
internal inline fun <T> Engine.withTemporaryPageResizeInteraction(
    enable: Boolean,
    action: () -> T,
): T {
    if (!enable) {
