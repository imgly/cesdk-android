...
private val strokeStyles = linkedMapOf(
    StrokeStyle.SOLID to PropertyOption(R.string.ly_img_editor_stroke_solid, StrokeStyle.SOLID.name),
    StrokeStyle.DASHED to PropertyOption(R.string.ly_img_editor_stroke_dashed, StrokeStyle.DASHED.name),
    StrokeStyle.DASHED_ROUND to PropertyOption(R.string.ly_img_editor_stroke_dashed_round, StrokeStyle.DASHED_ROUND.name),
    StrokeStyle.LONG_DASHED to PropertyOption(R.string.ly_img_editor_stroke_long_dashed, StrokeStyle.LONG_DASHED.name),
    StrokeStyle.LONG_DASHED_ROUND to
        PropertyOption(
            R.string.ly_img_editor_stroke_long_dashed_round,
            StrokeStyle.LONG_DASHED_ROUND.name,
        ),
    StrokeStyle.DOTTED to PropertyOption(R.string.ly_img_editor_stroke_dotted, StrokeStyle.DOTTED.name),
)
