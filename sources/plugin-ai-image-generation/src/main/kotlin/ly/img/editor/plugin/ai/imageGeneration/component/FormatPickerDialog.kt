        ...
        Column(
            ...
            Column(
                ...
                Row(
                    ...
                    Text(
                        text = stringResource(R.string.ly_img_plugin_ai_image_generation_title_select_format),
...
@Composable
internal fun FormatSelectionContent(
                ...
                Column(
                    ...
                    Row(
                        ...
                        OutlinedTextField(
                            ...
                            label = {
                                Text(text = stringResource(R.string.ly_img_plugin_ai_image_generation_text_image_width_px))
                            },
                        ...
                        OutlinedTextField(
                            ...
                            label = {
                                Text(text = stringResource(R.string.ly_img_plugin_ai_image_generation_text_image_height_px))
                            },
                            shape = RoundedCornerShape(12.dp),
                            modifier = Modifier
                                .weight(1f)
                        ...
                        IconButton(
                            ...
                            Icon(
                                ...
                                contentDescription = stringResource(R.string.ly_img_plugin_ai_image_generation_button_apply_custom_format),
...
internal fun FormatListItem(
    ...
    Row(
        ...
        Column(
            ...
            val text = remember(format) {
                "${format.ratio} (${format.label})".trim()
            }
            Text(
                text = text,
...
internal fun FormatPickerDialogPreview() {
    PreviewTheme {
        Surface {
            FormatPickerDialog(
...
internal fun FormatPickerDialogCustomPreview() {
    PreviewTheme {
        Surface {
            FormatPickerDialog(
